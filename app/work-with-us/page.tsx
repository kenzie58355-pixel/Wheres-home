...
<section style={{maxWidth:"1200px",margin:"70px auto 30px",padding:"0 48px",textAlign:"center"}}>
...
{whatWeDo.map((w, i) => (
<div key={i} style={{background:"var(--paper-2)",borderRadius:"18px",padding:"32px"}}>
...
<p style={{fontSize:"0.88rem",opacity:0.8,lineHeight:1.6}}>{w.desc}</p>
</div>
))}
</div>
</section>
...
<section style={{background:"var(--ink)",color:"var(--paper)",borderRadius:"20px",margin:"0 24px 90px",padding:"90px 48px",textAlign:"center"}}>
<h2 style={{fontFamily:"'Fraunces',serif",fontSize:"clamp(2.2rem,5vw,3.4rem)",fontWeight:600,marginBottom:"8px"}}>Where&apos;s Home?</h2>
<p style={{fontFamily:"'Fraunces',serif",fontSize:"clamp(1.6rem,3.4vw,2.2rem)",fontWeight:600,color:"var(--apricot)",marginBottom:"50px"}}>Let&apos;s find out.</p>

<form style={{maxWidth:"460px",margin:"0 auto",display:"flex",flexDirection:"column",gap:"14px",textAlign:"left"}}>
<input type="text" placeholder="Your name" style={{padding:"14px 18px",borderRadius:"12px",border:"none",fontFamily:"'Inter',sans-serif",fontSize:"0.9rem"}} />
<input type="email" placeholder="Email" style={{padding:"14px 18px",borderRadius:"12px",border:"none",fontFamily:"'Inter',sans-serif",fontSize:"0.9rem"}} />
<textarea placeholder="Tell us the plan" rows={4} style={{padding:"14px 18px",borderRadius:"12px",border:"none",fontFamily:"'Inter',sans-serif",fontSize:"0.9rem",resize:"vertical"}}></textarea>
<button type="button" style={{background:"var(--apricot)",color:"var(--ink)",padding:"16px",borderRadius:"100px",border:"none",fontWeight:700,fontSize:"0.95rem",cursor:"pointer",marginTop:"6px"}}>Send It</button>
</form>
</section>
<Footer />
</main>
