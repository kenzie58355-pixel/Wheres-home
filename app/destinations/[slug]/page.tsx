...
<div><div style={{fontFamily:"'Fraunces',serif",fontSize:"1.8rem",fontWeight:600}}>{dest.ginger.parksVisited}</div><div style={{fontSize:"0.72rem",opacity:0.75}}>Parks visited</div></div>
...
<section style={{maxWidth:"1200px",margin:"0 auto",padding:"0 48px 70px"}}>
<span style={{fontFamily:"'Space Mono',monospace",fontSize:"0.7rem",textTransform:"uppercase",letterSpacing:"0.08em",color:"var(--terracotta)",display:"block",marginBottom:"10px"}}>Explore</span>
<h2 style={{fontFamily:"'Fraunces',serif",fontSize:"clamp(1.8rem,3.4vw,2.6rem)",fontWeight:600,marginBottom:"12px"}}>Where to go, mapped.</h2>
<p style={{opacity:0.8,marginBottom:"30px"}}>Every pin below is somewhere Ginger and I actually went.</p>
<div style={{height:"320px",borderRadius:"18px",background:"radial-gradient(circle at 30% 40%,rgba(232,162,93,.25),transparent 45%),radial-gradient(circle at 70% 65%,rgba(30,74,71,.2),transparent 45%),var(--paper-2)",display:"flex",alignItems:"center",justifyContent:"center",border:"1px solid rgba(43,36,32,0.12)"}}>
<span style={{fontFamily:"'Space Mono',monospace",fontSize:"0.75rem",opacity:0.5,textTransform:"uppercase",letterSpacing:"0.08em"}}>Interactive Map, Prototype</span>
</div>
</section>
